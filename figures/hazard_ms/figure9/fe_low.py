...
# show data from fe_low_statsvti
fe_low_statsvtiDisplay = Show(fe_low_statsvti, renderView1, 'UniformGridRepresentation')
...
# trace defaults for the display properties.
fe_low_statsvtiDisplay.Representation = 'Slice'
fe_low_statsvtiDisplay.ColorArrayName = ['CELLS', 'PGA_0.1']
fe_low_statsvtiDisplay.LookupTable = pGA_01LUT
fe_low_statsvtiDisplay.SelectTCoordArray = 'None'
fe_low_statsvtiDisplay.SelectNormalArray = 'None'
fe_low_statsvtiDisplay.SelectTangentArray = 'None'
fe_low_statsvtiDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
fe_low_statsvtiDisplay.SelectOrientationVectors = 'None'
fe_low_statsvtiDisplay.ScaleFactor = 154400.0
fe_low_statsvtiDisplay.SelectScaleArray = 'None'
fe_low_statsvtiDisplay.GlyphType = 'Arrow'
fe_low_statsvtiDisplay.GlyphTableIndexArray = 'None'
fe_low_statsvtiDisplay.GaussianRadius = 7720.0
fe_low_statsvtiDisplay.SetScaleArray = [None, '']
fe_low_statsvtiDisplay.ScaleTransferFunction = 'PiecewiseFunction'
fe_low_statsvtiDisplay.OpacityArray = [None, '']
fe_low_statsvtiDisplay.OpacityTransferFunction = 'PiecewiseFunction'
fe_low_statsvtiDisplay.DataAxesGrid = 'GridAxesRepresentation'
fe_low_statsvtiDisplay.PolarAxes = 'PolarAxesRepresentation'
fe_low_statsvtiDisplay.ScalarOpacityUnitDistance = 25222.71540033692
fe_low_statsvtiDisplay.ScalarOpacityFunction = pGA_01PWF
fe_low_statsvtiDisplay.TransferFunction2D = pGA_01TF2D
fe_low_statsvtiDisplay.OpacityArrayName = ['CELLS', 'PGA_0.1']
fe_low_statsvtiDisplay.ColorArray2Name = ['CELLS', 'PGA_0.1']
fe_low_statsvtiDisplay.SliceFunction = 'Plane'
fe_low_statsvtiDisplay.SelectInputVectors = [None, '']
fe_low_statsvtiDisplay.WriteLog = ''

# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
fe_low_statsvtiDisplay.OSPRayScaleFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
fe_low_statsvtiDisplay.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
fe_low_statsvtiDisplay.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
fe_low_statsvtiDisplay.SliceFunction.Origin = [1590196.015518637, 5469386.7749801995, 10.0]
...
SetActiveSource(fe_low_statsvti)
# ----------------------------------------------------------------
