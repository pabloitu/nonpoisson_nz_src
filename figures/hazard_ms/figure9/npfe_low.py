...
coastlinevtm = XMLMultiBlockDataReader(registrationName='coastline.vtm', FileName=['/home/pciturri/PycharmProjects/nonpoisson_nz/figures/hazard_ms/figure9/paraview/coastline.vtm'])
coastlinevtm.CellArrayStatus = ['t50_fid', 'elevation']
coastlinevtm.TimeArray = 'None'

# create a new 'XML Image Data Reader'
m_statsvti = XMLImageDataReader(registrationName='m_stats.vti', FileName=['/home/pciturri/PycharmProjects/nonpoisson_nz/figures/hazard_ms/figure9/paraview/m_stats.vti'])
m_statsvti.CellArrayStatus = ['PGA_0.1', 'mask']
m_statsvti.TimeArray = 'None'

# create a new 'XML Image Data Reader'
basemap_2193vti = XMLImageDataReader(registrationName='basemap_2193.vti', FileName=['/home/pciturri/PycharmProjects/nonpoisson_nz/figures/hazard_ms/figure9/paraview/basemap_2193.vti'])
basemap_2193vti.CellArrayStatus = ['basemap', 'mask']
basemap_2193vti.TimeArray = 'None'

# create a new 'XML Image Data Reader'
npfe_low_statsvti = XMLImageDataReader(registrationName='npfe_low_stats.vti', FileName=['/home/pciturri/PycharmProjects/nonpoisson_nz/figures/hazard_ms/figure9/paraview/npfe_low_stats.vti'])
npfe_low_statsvti.CellArrayStatus = ['PGA_0.1', 'mask']
npfe_low_statsvti.TimeArray = 'None'

# create a new 'XML Image Data Reader'
fe_low_statsvti = XMLImageDataReader(registrationName='fe_low_stats.vti', FileName=['/home/pciturri/PycharmProjects/nonpoisson_nz/figures/hazard_ms/figure9/paraview/fe_low_stats.vti'])
fe_low_statsvti.CellArrayStatus = ['PGA_0.1', 'mask']
fe_low_statsvti.TimeArray = 'None'
...
# show data from npfe_low_statsvti
npfe_low_statsvtiDisplay = Show(npfe_low_statsvti, renderView1, 'UniformGridRepresentation')
...
pGA_01LUT.RGBPoints = [0.0, 0.278431372549, 0.278431372549, 0.858823529412, 0.08579999999999995, 0.0, 0.0, 0.360784313725, 0.171, 0.0, 1.0, 1.0, 0.25739999999999996, 0.0, 0.501960784314, 0.0, 0.3426, 1.0, 1.0, 0.0, 0.42840000000000017, 1.0, 0.380392156863, 0.0, 0.5141999999999999, 0.419607843137, 0.0, 0.0, 0.6, 0.878431372549, 0.301960784314, 0.301960784314]
...
pGA_01PWF.Points = [0.0, 0.0, 0.5, 0.0, 0.027000000700354517, 0.2663043439388275, 0.5, 0.0, 0.05580000206828115, 0.45652174949645996, 0.5, 0.0, 0.09240000694990162, 0.635869562625885, 0.5, 0.0, 0.13140000402927393, 0.7771739363670349, 0.5, 0.0, 0.20460000634193426, 0.8586956858634949, 0.5, 0.0, 0.6, 1.0, 0.5, 0.0]
pGA_01PWF.ScalarRangeInitialized = 1

# trace defaults for the display properties.
npfe_low_statsvtiDisplay.Representation = 'Slice'
npfe_low_statsvtiDisplay.ColorArrayName = ['CELLS', 'PGA_0.1']
npfe_low_statsvtiDisplay.LookupTable = pGA_01LUT
npfe_low_statsvtiDisplay.SelectTCoordArray = 'None'
npfe_low_statsvtiDisplay.SelectNormalArray = 'None'
npfe_low_statsvtiDisplay.SelectTangentArray = 'None'
npfe_low_statsvtiDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
npfe_low_statsvtiDisplay.SelectOrientationVectors = 'None'
npfe_low_statsvtiDisplay.ScaleFactor = 154400.0
npfe_low_statsvtiDisplay.SelectScaleArray = 'None'
npfe_low_statsvtiDisplay.GlyphType = 'Arrow'
npfe_low_statsvtiDisplay.GlyphTableIndexArray = 'None'
npfe_low_statsvtiDisplay.GaussianRadius = 7720.0
npfe_low_statsvtiDisplay.SetScaleArray = [None, '']
npfe_low_statsvtiDisplay.ScaleTransferFunction = 'PiecewiseFunction'
npfe_low_statsvtiDisplay.OpacityArray = [None, '']
npfe_low_statsvtiDisplay.OpacityTransferFunction = 'PiecewiseFunction'
npfe_low_statsvtiDisplay.DataAxesGrid = 'GridAxesRepresentation'
npfe_low_statsvtiDisplay.PolarAxes = 'PolarAxesRepresentation'
npfe_low_statsvtiDisplay.ScalarOpacityUnitDistance = 25222.71540033692
npfe_low_statsvtiDisplay.ScalarOpacityFunction = pGA_01PWF
npfe_low_statsvtiDisplay.TransferFunction2D = pGA_01TF2D
npfe_low_statsvtiDisplay.OpacityArrayName = ['CELLS', 'PGA_0.1']
npfe_low_statsvtiDisplay.ColorArray2Name = ['CELLS', 'PGA_0.1']
npfe_low_statsvtiDisplay.SliceFunction = 'Plane'
npfe_low_statsvtiDisplay.SelectInputVectors = [None, '']
npfe_low_statsvtiDisplay.WriteLog = ''

# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
npfe_low_statsvtiDisplay.OSPRayScaleFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
npfe_low_statsvtiDisplay.ScaleTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
npfe_low_statsvtiDisplay.OpacityTransferFunction.Points = [0.0, 0.0, 0.5, 0.0, 0.015200869180262089, 0.5955882668495178, 0.5, 0.0, 0.09229099005460739, 0.625, 0.5, 0.0, 0.10097720474004745, 0.8897058963775635, 0.5, 0.0, 0.2258414924144745, 0.9705882668495178, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
npfe_low_statsvtiDisplay.SliceFunction.Origin = [1590196.015518637, 5469386.7749801995, 10.0]
...
SetActiveSource(npfe_low_statsvti)
# ----------------------------------------------------------------
